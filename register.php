...
<div class="txt-heading" align="center">Simple Shopping Cart <!-- <a id="btnEmpty" href="checkout.php?action=empty">Empty Cart</a> --></div>
<br>
<?php
...
<tbody>
<tr>
<th style="text-align:center; margin-right: 20px;"><strong>Nama Barang</strong></th>
<th style="text-align:center; margin-right: 20px;"><strong>ID Barang</strong></th>
<th style="text-align:center; margin-right: 20px;"><strong>Qty</strong></th>
<th style="text-align:center; margin-right: 20px;"><strong>Harga </strong></th>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				<tr>
				<td style="text-align:left;border-bottom:#F0F0F0 1px solid; padding:0 15px 0 15px;"><strong><?php echo $item["brg_nama"]; ?></strong></td>
				<td style="text-align:center;border-bottom:#F0F0F0 1px solid; padding:0 15px 0 15px;"><?php echo $item["brg_id"]; ?></td>
				<td style="text-align:center;border-bottom:#F0F0F0 1px solid; padding:0 15px 0 15px;"><?php echo $item["quantity"]; ?></td>
				<td style="text-align:right;border-bottom:#F0F0F0 1px solid; padding:0 15px 0 15px;"><?php echo "Rp ".$item["brg_harga"]; ?></td>

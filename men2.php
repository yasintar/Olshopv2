					  ...
					  <li class="simpleCart_shelfItem">
							...
							<div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/menloafers.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Men Loafers</p>
									   </div>
									   <div class="mount item_price price">Rp200.000</div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="single.php">
							 <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/mensneakers.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
						...
						<li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="single.php">
							  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/redtape.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Red Tape</p>
									   </div>
						...
						<li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="single.php">
							   <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/casualtro.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Casual Trouser</p>
									   </div>
